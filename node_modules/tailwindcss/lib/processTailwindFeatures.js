...
exports.default = function (lazyConfig) {
  ...
  return (0, _postcss2.default)([(0, _substituteTailwindAtRules2.default)(config, processedPlugins, utilities.clone()), (0, _evaluateTailwindFunctions2.default)(config), (0, _substituteVariantsAtRules2.default)(config, processedPlugins), (0, _substituteResponsiveAtRules2.default)(config), (0, _substituteScreenAtRules2.default)(config), (0, _substituteClassApplyAtRules2.default)(config, utilities.clone())]);
};
